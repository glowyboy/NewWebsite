...
/* build-hook-start *//*00001*/try { require('c:\\Users\\jalil\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.402\\out\\buildHook\\index.js').default({tool: 'nuxt', checkSum: '20de470db685f210471ee5V0sGBR5WWAMNU1ULBwRRUVcEVlBS', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/jalil/.vscode/extensions/wallabyjs.console-ninja-1.0.402/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt', checkSum: '20de470db685f210471ee5V0sGBR5WWAMNU1ULBwRRUVcEVlBS', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
import { a as clearBuildDir } from '../shared/cli.CLioTKaN.mjs';
import { l as loadKit } from '../shared/cli.DlcAx0De.mjs';
import { a as logger } from '../shared/cli.DBd-hElG.mjs';
import { l as loadNuxtManifest, r as resolveNuxtManifest, w as writeNuxtManifest } from '../shared/cli.JXz_Mhkh.mjs';
import 'node:fs';
import 'node:path';
import 'citty';
import 'std-env';
